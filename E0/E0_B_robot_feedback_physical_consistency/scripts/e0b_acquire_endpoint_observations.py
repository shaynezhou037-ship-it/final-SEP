...
#
# PURPOSE:
# Compare physically observed needle-tip endpoint displacement with
# RoArm T105 internally reported Cartesian endpoint displacement.
#
# IMPORTANT:
# - This dataset is NOT used as a pure robot-repeatability estimate.
# - Different high joint-space starting poses were used during acquisition.
# - That is an experimental condition only; no causal claim is made that
#   starting configuration caused the observed endpoint deviations.
# - The large endpoint deviations are retained because both physical
#   observation and T105 feedback showed corresponding displacement.
# ================================================================
...
def main():
    ...
    print()
    print("=" * 72)
    print("E0-B ROBOT REPEATABILITY — YUNKAI FINAL PIPELINE")
    print("=" * 72)
    ...
    print("  This is repeatability, not absolute target accuracy.")
    print()
